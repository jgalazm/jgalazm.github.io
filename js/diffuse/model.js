...
function init(){
	...
	modelMaterial = new THREE.ShaderMaterial({
		uniforms: mUniforms,
		vertexShader: $.ajax('js/diffuse/shaders/vshader.glsl',{async:false}).responseText,
		fragmentShader: $.ajax('js/diffuse/shaders/modelFShader.glsl',{async:false}).responseText
	});

	screenMaterial = new THREE.ShaderMaterial({
		uniforms: mUniforms,
		vertexShader: $.ajax('js/diffuse/shaders/vshader.glsl',{async:false}).responseText,
		fragmentShader: $.ajax('js/diffuse/shaders/screenFShader.glsl',{async:false}).responseText
	});
